...
import { X, Key, Globe, Shield, Save, Check, Sparkles } from 'lucide-react';
...
export const ConfigModal: React.FC<ConfigModalProps> = ({ isOpen, onClose, systemStatus }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="glass-panel-glow w-full max-w-lg rounded-3xl p-6 space-y-5 relative shadow-2xl">
        
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div className="flex items-center space-x-2">
            <Shield className="w-5 h-5 text-swiggy-orange" />
            <h3 className="font-extrabold text-lg text-white">System Configuration</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4 text-xs">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="sk-..."
              className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-slate-100 focus:outline-none focus:border-swiggy-orange font-mono"
            />
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-1.5 text-slate-100 focus:outline-none focus:border-swiggy-orange"
                />
              </div>
        ...
        <div className="pt-2 flex items-center justify-end space-x-3 border-t border-slate-800">
          ...
          <button
            onClick={handleSave}
            className="px-5 py-2 bg-swiggy-orange hover:bg-swiggy-hover text-white rounded-xl text-xs font-bold transition flex items-center space-x-1.5 shadow-md shadow-orange-500/20"
          >
